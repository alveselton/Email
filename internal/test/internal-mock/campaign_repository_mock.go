...
func (r *CampaignRepositoryMock) Create(compaign *campaign.Campaign) error {
	args := r.Called(compaign)
	return args.Error(0)
}
...
func (r *CampaignRepositoryMock) Delete(compaign *campaign.Campaign) error {
	args := r.Called(compaign)
	return args.Error(0)
}
